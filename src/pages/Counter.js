...
import Counter from '@madebyme/counter';
import Description from 'components/Description';
const CounterPage = () => (
  <div>
    <Description>
      This page is using {'<Counter />'} component from @madebyme/counter npm
      ...
      useCounter() hook that exposes all its internal state so you can choose to
